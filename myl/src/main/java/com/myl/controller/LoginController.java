...
public class LoginController extends ActionSupport implements
	...
	public String execute() throws Exception {
		...
		System.out.println("holaaaaaa " + service.digestPassword(password));
		usuarioAux.setPassword(service.digestPassword(password));
		...
		try {
			...
			if (usuarios.isEmpty()) {
				...
				ActionContext.getContext().getSession()
						.put(NombreObjetosSesion.USUARIO, usuarioSel);
				return "next";
			}
