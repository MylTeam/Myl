/**
 * Funciones y constantes javascript de utilidad com�n.
...
var localizacionDataTables = {
	oLanguage : {
		oPaginate : {
			sFirst : "Primera p�gina",
			sNext : "�ltima p�gina",
			sNext : "�ltima p�gina",
			sPrevious : "P�gina previa"
		},
		sProcessing : "Procesando al m�ximo",
 ...
 * capacidad es la misma que la funcion <code>typeof</code>, pero a�ade la
...
function distanciaEntreFechas(feuno, fedos) {
	var duno = feuno.getTime();
	var ddos = fedos.getTime();
	var distancia;

	distancia = Math.round((ddos - duno) / 86400000);
