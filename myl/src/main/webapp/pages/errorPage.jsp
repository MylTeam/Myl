	...
	<s:property value="exception" />
		...
		<div class="form">
			...
			<div id="sendingReport">
				...
				<p>Espere, estamos recolectando algunos datos para generar un reporte automático. Este nos ayudará encontrar una solución al problema.</p>
			</div>
			...
			<div id="reportFailure">
				...
				<p>No se pudo enviar el reporte, de clic <a href="#" onclick="reenviaReporteError()" class="colorBlue">aqui</a> para intentar de nuevo o contacte al administrador.</p>
			</div>			
		</div>
