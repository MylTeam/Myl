...
<jsp:root xmlns:jsp="http://java.sun.com/JSP/Page" version="2.0"
	...
	<s:url id="urlCancelar" value="/catalogo-exposicion" includeContext="true" />
	...
	<s:form
		...
		<label>Nombre:</label>
		<s:textfield id="Nombre" name="model.nombre" maxlength="50" disabled="true"/>
		<br/>		
		<label>Descripción:</label>
		<br/>
		<s:textarea  rows="3" cols="70"  id="Descripcion" name="model.descripcion" maxlength="200"  disabled="true"/>
		<br/>
		<table id="tblMuseo">
			<thead>
				<tr>
