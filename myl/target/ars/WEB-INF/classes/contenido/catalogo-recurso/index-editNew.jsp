...
<body>
	...
	<s:form
		action="%{#request.contextPath}/catalogo-recurso.action"
		method="post" theme="simple" acceptcharset="UTF-8" id="frmRecurso" enctype="multipart/form-data" cssStyle="border: 0px">
		<center>
			...
			<table>				
				...
				<tr>
				<td colspan="2" >
				<s:a href="/ars/download.action"><input
				type="button" value="Descargar Imagenes" ></input></s:a>
				</td>
				</tr>
				<tr>
