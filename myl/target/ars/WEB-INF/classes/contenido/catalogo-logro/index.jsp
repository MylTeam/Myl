...
<body>
						...
						<tr>
							...
							<td width="90"><a
								href="${pageContext.request.contextPath}/catalogo-logro/${idLogro}/edit.action?idMuseoSel=${idMuseoSel}"><img
									height="40" width="40"
									src="${pageContext.request.contextPath}/images/buttons/botEditar2.png" title="Modificar Logro"/></a>
									<a
								href="${pageContext.request.contextPath}/catalogo-logro/${idLogro}/deleteConfirm.action?idMuseoSel=${idMuseoSel}"><img
									height="40" width="40"
									src="${pageContext.request.contextPath}/images/buttons/eliminar.png" title="Eliminar Logro"/></a>
	...
	<center>
		<a href="${pageContext.request.contextPath}/catalogo-logro/new.action?idMuseoSel=${idMuseoSel}"><input
			type="submit" value="Nuevo Logro"></input></a>
			<a
