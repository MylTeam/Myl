					...
					<td><table>
							...
							<tr>
								...
								<td colspan="3"><s:textarea rows="4" cols="60"
										id="Descripcion" name="model.descripcion" maxlength="200" disabled="true"/></td>
							</tr>
							<tr>
								<td><label>Calle:</label></td>
								<td><s:textfield id="calle" name="model.calle" maxlength="50" disabled="true"/></td>
								<td><label>Número:</label></td>
								<td><s:textfield id="numero" name="model.numero" maxlength="50" disabled="true"/></td>
							</tr>
							<tr>
								<td><label>Colonia:</label></td>
								<td><s:textfield id="colonia" name="model.colonia" maxlength="50" disabled="true"/></td>
								<td><label>Delegación:</label></td>
								<td><s:textfield id="delegacion" name="model.delegacion" maxlength="50" disabled="true"/></td>
							</tr>
							<tr>
								<td><label>Estado:</label></td>
								<td><s:textfield id="estado" name="model.estado" maxlength="50" disabled="true"/></td>
								<td><label>CP:</label></td>
								<td><s:textfield id="codigo" name="model.codigo" maxlength="50" disabled="true"/></td>
							</tr>							
							<tr>
								<td><label>Contacto:</label></td>
								<td colspan="3"><s:textfield id="contacto" name="model.contacto" maxlength="50"
										size="60" disabled="true"/></td>
							</tr>
							<tr>								
								<td><label>Actividad:</label></td>
								<td><s:textfield id="actividad" name="model.edoMuseo" maxlength="50" disabled="true" /></td>
							</tr>
