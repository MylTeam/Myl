...
<body>
	...
	<s:url id="urlCancelar" value="/catalogo-logro.action?idMuseoSel=%{idMuseoSel}" includeContext="true" />
	<s:actionerror id="saeLogro" theme="jquery" />
	<s:fielderror id="sfeLogro" theme="jquery" />


	<s:form action="%{#request.contextPath}/catalogo-logro.action?idMuseoSel=%{idMuseoSel}" method="post"
		theme="simple" acceptcharset="UTF-8" align="center" id="frmLogro"
			...
			<table>
				<tr>
					<td style="text-align: center"><label>Seleccione el
							...
							label="Elementos Registrados" name="" id="slcIdElementosDisponibles"
							list="elementosRegistrados" listValue="nombre" listKey="idElemento"
							doubleName="idElementosSeleccionados"
							doubleId="slcIdElementosSeleccionados" doubleList="elementosLogro"
							doubleListValue="nombre" allowUpDownOnLeft="false"
							doubleListKey="idElemento" allowUpDownOnRight="false"
							allowAddAllToLeft="false" allowAddAllToRight="false"
							allowSelectAll="false" /><br /></td>
					<td><table>
							<tr>
