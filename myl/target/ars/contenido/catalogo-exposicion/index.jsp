...
<body>
<form style="width: 80%; border: 0px"><center>
				...
				<tr>
					...
					<td width="90"><a
						href="${pageContext.request.contextPath}/catalogo-exposicion/${idExposicion}/edit.action"><img
							height="40" width="40"
							src="${pageContext.request.contextPath}/images/buttons/botEditar2.png" title="Modificar Exposición"/></a>						
							<a
								href="${pageContext.request.contextPath}/catalogo-elemento.action?idExpoSel=${idExposicion}"><img
							height="40" width="40"
							src="${pageContext.request.contextPath}/images/buttons/Elemento.jpg" title="Ver Elementos"/></a>
					</td>
				</tr>
			</s:iterator>
		</tbody>
	...
	<center>
	<a href="${pageContext.request.contextPath}/catalogo-exposicion/new.action"><input
		type="submit" value="Agregar Exposicion"></input></a>
		<a
