...
<body>
	...
	<s:url id="urlCancelar" value="/catalogo-subtema.action" includeContext="true" />
	<s:actionerror id="saeMuseo" theme="jquery" />
	<s:fielderror id="sfeMuseo" theme="jquery" />


	<s:form action="%{#request.contextPath}/catalogo-subtema.action" method="post"
		theme="simple" acceptcharset="UTF-8" cssStyle="border: 0px;">
		<center>
			<h1>Agregar Subtema</h1>
		</center>
		<table>
			<tr>
			...
			<tr>
				<td colspan="2" style="text-align: center;"><sj:submit id="btnAceptar" value="Aceptar"
						...
						button="true" href="#" onclick="location.href='%{urlCancelar}'">Cancelar</sj:a>
				</td>
			</tr>
