...
<body>
	...
	<s:url id="urlCancelar" value="/catalogo-museo.action" includeContext="true" />
	<s:actionerror id="saeMuseo" theme="jquery" />
	<s:fielderror id="sfeMuseo" theme="jquery" />


	<s:form action="%{#request.contextPath}/catalogo-museo.action" method="post"
		theme="simple" acceptcharset="UTF-8" align="center" id="frmMuseo" cssStyle="border: 0px" enctype="multipart/form-data">
		<center>
			<h1>Agregar Museo</h1>			
			<table>
				<tr>
					<td style="text-align: center">
					<label>Seleccione el tema o temas del Museo:</label><br/>
					...
					<td><table>
							...
							<tr>
								...
								<td><s:textfield id="calle" name="model.calle" maxlength="50" /></td>
								<td><label>Número:</label></td>
								<td><s:textfield id="numero" name="model.numero" maxlength="50" /></td>
							</tr>
							<tr>
								<td><label>Colonia:</label></td>
								<td><s:textfield id="colonia" name="model.colonia" maxlength="50" /></td>
								<td><label>Delegación:</label></td>
								<td><s:textfield id="delegacion" name="model.delegacion" maxlength="50" /></td>
							</tr>
							<tr>
								<td><label>Estado:</label></td>
								<td><s:textfield id="estado" name="model.estado" maxlength="50" /></td>
								<td><label>CP:</label></td>
								<td><s:textfield id="codigo" name="model.codigo" maxlength="50" /></td>
							</tr>
							<tr>
								<td><label>Contacto:</label></td>
								<td colspan="3"><s:textfield name="model.contacto" id="contacto" maxlength="50"
										size="60" /></td>
							</tr>
							<tr>								
