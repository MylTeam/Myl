...
<body>
						...
						<tr>
							...
							<td width="90"><a
								href="${pageContext.request.contextPath}/catalogo-elemento/${idElemento}/edit.action"><img
									height="40" width="40" src="images/buttons/botEditar2.png" title="Modificar Elemento"/></a> <a
								href="${pageContext.request.contextPath}/catalogo-elemento/${idElemento}/deleteConfirm.action"><img
									height="40" width="40" src="images/buttons/eliminar.png" title="Eliminar Elemento"/></a>
							</td>
						</tr>
					</s:iterator>
				</tbody>
	...
	<center>
		<br /> <a
			...
			type="submit" value="Nuevo Elemento" size="200px"></input></a>
			<a
			...
			type="submit" value="Descargar Imagenes" ></input></s:a>						
	</center>
</body>
	</html>
</jsp:root>
